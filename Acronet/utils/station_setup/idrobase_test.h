...
#ifndef IDROBASE_TEST_H_
#define IDROBASE_TEST_H_

#define USES_PULSE_CHAN_0
#define USES_GPIO_CHAN_0
#define MODULE_DECLARATION ((MOD_ID_GPIO2LOG,(GPIO_CHAN_0)))((MOD_ID_RAINGAUGE,(PULSE_CHAN_0)))
