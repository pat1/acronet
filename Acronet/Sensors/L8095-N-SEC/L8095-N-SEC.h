...
#ifndef L8095N_SEC_H_
#define L8095N_SEC_H_

//#define L8095N_SEC_PUSART SP336_USART1
//#define L8095N_SEC_PIN_TX_ENABLE SP336_USART1_PIN_TX_ENABLE
//#define L8095N_SEC_PIN_TX_SIGNAL	SP336_USART1_PIN_TX_SIGNAL
//#define L8095N_SEC_PIN_RX_SIGNAL SP336_USART1_PIN_RX_SIGNAL


#define L8095_SEC_SWITCH_PIN					IOPORT_CREATE_PIN(PORTD, 1)
...
RET_ERROR_CODE l8095n_sec_Data2String(	 const L8095N_DATA * const st
									,char * const sz
									,uint16_t * len_sz);
