...
static RET_ERROR_CODE PCAL9535A_internal_Init( void )
{
	...
	/////////
	/////////
	RET_ERROR_CODE r = PCAL9535A_Write(0x6,(SP336_SELECTED_SETUP | 0b00000111)) ; //0b01101111
	delay_ms(5);
	if(AC_ERROR_OK != r )
	{
		return r;
	...
	///////// RESISTOR
	/////////
	r = PCAL9535A_Write(0x46,0b00001111);
	delay_ms(5);
	if(AC_ERROR_OK != r )
	{
		return r;
	...
	///////////////////////////////////////////////////////////
	///////// PORT1 WRITE
	r = PCAL9535A_Write(0x3,0b00000000); //0b00001111
	delay_ms(5);
	if(AC_ERROR_OK != r )
	{
		return r;
