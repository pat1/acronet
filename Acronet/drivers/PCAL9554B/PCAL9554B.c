...
static RET_ERROR_CODE PCAL9554B_internalWrite(twi_package_t * ppak);
static RET_ERROR_CODE PCAL9554B_internalRead(twi_package_t * ppak);


//RET_ERROR_CODE PCAL9554B_Init( void )
//{
	//DEBUG_PRINT_FUNCTION_NAME(NORMAL,"PCAL9554B_INIT");
			//
	//twi_master_options_t opt = {
		//.speed = PCAL9554B_TWI_SPEED,
		//.chip  = TWI_MASTER_ADDRESS,
	//};
			//
	//twi_master_setup(PCAL9554B_TWI_PORT, &opt);
			//
//
	////if (STATUS_OK==e)
	////{
...
//
	//return PCAL9554B_internal_Init();
//}


static RET_ERROR_CODE PCAL9554B_internalWrite(twi_package_t * ppak)
{
	static const char __flash funName[] = "PCAL9554B_internalWrite";
	
	//debug_string("Before write\r\n");
	const status_code_t r = twi_master_write(PCAL9554B_TWI_PORT, ppak);
...
static RET_ERROR_CODE PCAL9554B_internalRead(twi_package_t * ppak)
{
	const char * const funName = PSTR("PCAL9554B_internalRead");

	const status_code_t r = twi_master_read(PCAL9554B_TWI_PORT, ppak);
	switch(r) {
		case TWI_SUCCESS:
...
RET_ERROR_CODE PCAL9554B_Write( const uint8_t cmd, const uint8_t data  )
{
	twi_package_t packet = {
		...
		.chip         = PCAL9554B_CHIP_ADDR ,      // TWI slave bus address
		.buffer       = NULL, // transfer data source buffer
		.length       = 0// transfer data size (bytes)
	};

	return PCAL9554B_internalWrite(&packet);
...
RET_ERROR_CODE PCAL9554B_Read( const uint8_t cmd, uint8_t * const data  )
{
	...
	return PCAL9554B_internalRead(&packet);
...
//
	...
	///////////
	//
	//RET_ERROR_CODE r = PCAL9554B_Write(0x6,0b00000111); //0b01101111
	//delay_ms(5);
	//if(AC_ERROR_OK != r )
	//{
		//return r;
...
//
	...
	/////////// RESISTOR
	///////////
	//r = PCAL9554B_Write(0x46,0b11111111);
	//delay_ms(5);
	//if(AC_ERROR_OK != r )
	//{
		//return r;
...
//
	//r = PCAL9554B_Write(0x48,0b00110111);
	//delay_ms(5);
	//if(AC_ERROR_OK != r )
	//{
		//return r;
...
//
	///////////////////////////////////////////////////////////////
	/////////// PORT0 OUTPUT WRITE
	//r = PCAL9554B_Write(0x2,0b00000000);
	//delay_ms(5);
	//if(AC_ERROR_OK != r )
	//{
		//return r;
	...
	/////////////////////////////////////////////////////////////
	/////////// PORT1 CONFIG
	//r = PCAL9554B_Write(0x7,0b11110000);
	//delay_ms(5);
	//if(AC_ERROR_OK != r )
	//{
		//return r;
	...
	/////////////////////////////////////////////////////////////
	/////////// PORT1 WRITE
	//r = PCAL9554B_Write(0x3,0b00000000);
	//delay_ms(5);
	//if(AC_ERROR_OK != r )
	//{
		//return r;
